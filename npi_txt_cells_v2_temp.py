...
filename='temp/W10_BadCells_kr.txt'
print(filename)
DELTA_FOR_PRINT=50000

def insert_data(ROW={},*args):
    sql = "INSERT INTO NPI.V1904_CELLS_TEMP_KR5 ({param_name}) VALUES ({param_value})"
    param_names = ''
    param_values = ''
    zpt = ''
...
'''
sql="TRUNCATE TABLE NPI.V1904_CELLS_TEMP_KR1"
print(sql)
cur.execute(sql)
con.commit()
'''
